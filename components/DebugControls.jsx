...
class DebugControls extends React.Component {
    ...
    handleKeyDown(event) {
        switch (event.key) {
            case "a":
                this.handleClick(ALL_EMOTIONS[0]);
                break;
            case "s":
                this.handleClick(ALL_EMOTIONS[1]);
                break;
            case "d":
                this.handleClick(ALL_EMOTIONS[2]);
                break;
            case "f":
                this.handleClick(ALL_EMOTIONS[3]);
                break;
            case "g":
                this.handleClick(ALL_EMOTIONS[4]);
                break;
            default:
                break;
        }
            ...
            <div className="panel">
                ...
                <div className="button-group">
                    {ALL_EMOTIONS.map(emotion => (
                        <button key={emotion} onClick={() => this.handleClick(emotion)}>
