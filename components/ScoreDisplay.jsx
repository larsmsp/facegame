...
class ScoreDisplay extends React.Component
{
    ...
    componentWillUpdate(nextProps) {
        if (nextProps.score != this.props.score) {
            ...
            newIncoming.timer = setTimeout(this._updateVisibleStatus.bind(this, insertedAt), SCORE_VISIBLE_FOR_MILLISECONDS)
    ...
    renderIncomingScore(score, i) {
        return (
            <li className={score.visible ? 'visible' : ''} key={i}>+{score.points}</li>
        )
    }
        ...
        return (
            <div className="score-display">
                ...
                <ul className="latest-scores">
                    {this.state.incomingScores.map(this.renderIncomingScore.bind(this))}
                </ul>
            </div>
        )
    }
